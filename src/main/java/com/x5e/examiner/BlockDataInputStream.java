...
class BlockDataInputStream
        extends InputStream implements DataInput
    {
        ...
        void handleReset() { throw new RuntimeException("resets not handled"); }
        ...
        private static void bytesToFloats(byte[] src, int srcpos,
                                                 ...
                                                 int nfloats) {
            throw new RuntimeException("bytesToFloats not implemented! ");
        }
        ...
        private static void bytesToDoubles(byte[] src, int srcpos,
                                                  ...
                                                  int ndoubles) {
            throw new RuntimeException("bytesToDoubles not implemented!");
        }
